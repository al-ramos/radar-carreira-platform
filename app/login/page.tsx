...
export default function LoginPage() {
  ...
  return <main className="login-page">
    ...
    <form className="login-card" onSubmit={submit}>
      ...
      <label>E-mail <small>{creatingAccount ? "usado para acessar sua conta" : "somente para usuários cadastrados"}</small><input autoComplete="username" onChange={event => setEmail(event.target.value)} placeholder="voce@exemplo.com" required type="email" value={email} /></label>
      <label>Senha<input autoComplete={creatingAccount ? "new-password" : "current-password"} autoFocus onChange={event => setPassword(event.target.value)} required type="password" value={password} /></label>
