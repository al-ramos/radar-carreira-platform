        ...
        <div className="triage-title">
          <div>
            ...
            <details className="triage-actions">
              ...
              <small>Acompanhe o resultado no cartão “Último lote manual”, logo abaixo. Toda decisão ✅ com e-mail válido cria o rascunho com currículo e assinatura e o envia automaticamente. Vereditos 🟡 continuam aguardando revisão.</small>
              </div>
            </details>
          </div>
        </div>
