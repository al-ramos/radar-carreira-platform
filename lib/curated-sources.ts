...
export const QUARANTINED_SOURCES: (CuratedSource & { reason: string })[] = [
  ...
  { id: "greenhouse-tcs", name: "TCS", provider: "greenhouse", externalRef: "tcs", reason: "empresa incorreta: retorna vagas da Thornbury Community Services (saúde, Reino Unido)" },
  ...
  { id: "greenhouse-new", name: "New Balance Brasil", provider: "greenhouse", externalRef: "new", reason: "empresa incorreta: retorna 1 vaga de 2021 de \"Sonja Inc.\"" },
  ...
  { id: "lever-blue", name: "Blue Prism", provider: "lever", externalRef: "blue", reason: "empresa incorreta: retorna vagas da BlueCloud (consultoria Snowflake)" },
  ...
  { id: "greenhouse-psl", name: "PSL Corp", provider: "greenhouse", externalRef: "psl", reason: "empresa incorreta: retorna vagas de \"Pearson Spectre Litt\"" },
  { id: "ashby-kin", name: "Kin + Carta", provider: "ashby", externalRef: "kin", reason: "empresa incorreta: retorna vagas da Kin Insurance (seguros residenciais, EUA)" },
  { id: "greenhouse-via", name: "Via", provider: "greenhouse", externalRef: "via", reason: "empresa incorreta: retorna vagas da Via Transportation (mobilidade urbana, EUA)" },
  ...
  { id: "greenhouse-bold", name: "Bold Commerce", provider: "greenhouse", externalRef: "bold", reason: "estagnada: apenas 1 vaga registrada, sem publicação desde 2024" },
];
