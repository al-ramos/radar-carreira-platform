...
`alexsandroProfilePreset()` é apenas um atalho de preenchimento inicial da tela. Ele não pode ser usado para avaliar vagas, autorizar candidaturas ou completar competências ausentes.
